...
Net effect: 27/27 tests passing (up from 17 — the pure reducer made exhaustive edge-case coverage cheap), 87.04% statement coverage (up from 82.84%), lint/build/format all still clean.
