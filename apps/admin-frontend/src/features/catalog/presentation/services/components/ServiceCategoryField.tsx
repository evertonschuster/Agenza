...
} from '@/features/catalog/presentation/categories/forms/CategoryForm'
import {
  categoryFieldMap,
  categoryCodeFieldMap,
} from '@/features/catalog/presentation/categories/forms/categoryFieldMaps'
        ...
        render={({ field }) => (
          <>
            ...
            <CreatableSingleSelect
              ...
              isCreating={createCategory.isCreatingNow}
